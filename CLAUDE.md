...
10. **The Tool Library is not hand-reviewed at every tier.** Tier 1 ("Light-approved") is reviewed; Tier 2 ("SDK-built") installs anything Light's server built and signed, with no manual approval. **Installed ≠ approved** — do not conflate them in a milestone.
